...
do
  prefix=A_$A
  commonArgs="--folder=. --p=$p --A=$A --linearSlope=$slope_ref --C=$C_ref --lambda_0=$lambda_ref --maxValue=$maxXg --minValue=$minXg"
...
do
  prefix=C_$C
  commonArgs="--folder=. --p=$p --A=$A_ref --linearSlope=$slope_ref --C=$C --lambda_0=$lambda_ref --maxValue=$maxXg --minValue=$minXg"
...
do
  prefix=slope_$slope
  commonArgs="--folder=. --p=$p --A=$A_ref --linearSlope=$slope --C=$C_ref --lambda_0=$lambda_ref --maxValue=$maxXg --minValue=$minXg"
...
do
  ...
  commonArgs="--folder=. --p=$p --A=$A_ref --linearSlope=$slope_ref --C=$C_ref --lambda_0=$lambda_0 --maxValue=$maxXg --minValue=$minXg"
...
#do
#  prefix=lambda_0_$lambda_0
#  commonArgs="--folder=. --p=$p --A=$A_ref --linearSlope=$slope_ref --C=$C_ref --lambda_0=$lambda_0 --maxXg=$maxXg --minXg=$minXg"
#  echo p_$p/vary_lambda_0 >> $fileName
#  echo $prefix >> $fileName
#  echo $commonArgs >> $fileName
#done
...
do
  prefix=W_$W
  commonArgs="--folder=. --p=$p --A=$A_ref --linearSlope=$slope_ref --C=$C_ref --lambda_0=$lambda_ref --maxValue=$maxXg --minValue=$minXg --useChannelWidth --W0=$W --Wx=0.0"
